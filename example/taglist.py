...
from tscat_gui.utils.keyword_list import EditableKeywordListWidget
...
if __name__ == "__main__":
    ...
    w = EditableKeywordListWidget(
        ['orbit1', 'moon', 'missionX', '123', '123'],
        ['orbit1', 'moon', 'missionX', '123', 'orbit2', 'mars', 'earth'],
        parent=main)
    # w.setMinimumWidth(700)

    w.editing_finished.connect(lambda x: print('new tags', x))
